  ...
  return (
    <>
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        <CommandInput placeholder="Rechercher un contact..." className="focus-visible:ring-0 focus-visible:ring-offset-0 focus:outline-none" />
        <CommandList>
          <CommandEmpty>Aucun contact trouvé.</CommandEmpty>
          <CommandGroup heading="Contacts">
            {Object.values(contactsData.contacts || {}).map((contact, index) => (
